...
import { Swords, Users, Zap, Play, ShieldAlert, Trophy, ShieldHalf, BarChart3, Star } from "lucide-react";
    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      ...
      <Card className="mt-12 text-center p-6 bg-gradient-to-br from-accent/80 to-primary/70 rounded-lg shadow-2xl text-accent-foreground">
        ...
        <p className="text-lg mb-5 max-w-md mx-auto">
            Gain access to exclusive seasonal rewards, bonus XP, unique power-ups, and more for just <Badge variant="secondary" className="text-lg px-3 py-1">₹99/season</Badge>!
        </p>
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button size="lg" className="bg-yellow-400 hover:bg-yellow-500 text-yellow-900 font-semibold opacity-50 cursor-not-allowed shadow-md" disabled>
                Get Premium Access
              </Button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Battle Pass and payment integration coming soon!</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        <p className="text-xs text-yellow-200/80 mt-3">(Secure UPI payments will be supported)</p>
      </Card>
