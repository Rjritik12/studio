...
import { Loader2, LogInIcon, KeyRound } from 'lucide-react'; // Using KeyRound as a generic auth icon
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] py-12">
      <Card className="w-full max-w-sm shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in with your Google account to continue to EduVerse.</CardDescription>
        </CardHeader>
