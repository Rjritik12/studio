...
import { Inbox, MessageCircle, IndianRupee, Users, Clock, PlusCircle, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      <div className="container mx-auto py-8 px-4 md:px-6">
        ...
        <Tabs defaultValue="chats" className="w-full max-w-2xl mx-auto">
          <TabsList className="grid w-full grid-cols-2 mb-6">
            <TabsTrigger value="chats">
              <Inbox className="mr-2 h-4 w-4 sm:h-5 sm:w-5" /> 1-on-1 Chats
            </TabsTrigger>
            <TabsTrigger value="groups">
              <Users className="mr-2 h-4 w-4 sm:h-5 sm:w-5" /> Study Groups
            </TabsTrigger>
          </TabsList>
            ...
            <Card className="shadow-xl">
              <CardHeader>
                <CardTitle className="font-headline text-xl sm:text-2xl flex items-center">
                  <Inbox className="mr-3 h-5 w-5 sm:h-6 sm:w-6 text-primary" /> Inbox
                </CardTitle>
                <CardDescription>
        ...
        <Alert variant="default" className="mt-8 w-full max-w-2xl mx-auto bg-primary/10 border-primary/30">
