...
interface ModuleDisplayClientProps {
  params: { moduleId: string };
}

export default function ModuleDisplayClient({ params }: ModuleDisplayClientProps) {
  const router = useRouter();
  // Note: We use `params` prop directly instead of `useParams()` 
  // because `params` is passed down from the Server Component (page.tsx)
